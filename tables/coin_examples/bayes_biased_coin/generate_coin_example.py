...
with open('bayes_biased_coin_example.tex', 'w') as f_table:
  column_names = ['h', 't', 'p_H', 'p_biased']
  ...
  for (h,t) in zip([10, 7, 5, 75], [0, 3, 5, 25]):
    for p_H in [1., 0.8, 0.6]:
      ...
      result = '{h:d}, {t:d}, {p_H:.2f}, {p_biased:.5f}'.format(h=h, t=t, p_H=p_H, p_biased=p_biased(h, t, n, m, p_H))
      print(result)
