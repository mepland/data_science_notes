...
\caption{
Additional information, such as the $F_{1}$ score and number of predicted positive members,
can be plotted as a function of recall on a single ROC plot,
at the cost of potentially making the plot harder to read.
}
