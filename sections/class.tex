...
% TODO explain how CART chooses from potential splits based on the maximum decrease in impurity
...
Similar to CART, FIGS can also set a hyperparameter for the minimum decrease in impurity.
