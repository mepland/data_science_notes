...
% TODO move eq:time_series:AR:convolution to class:CNN?
% Would then need to explain convolution as used in mathematics vs cross correlation as is actually used for "convolution" in ML/CNNs
...
% Adapted from "Time Series Analysis, Forecasting, and Machine Learning" https://www.udemy.com/course/time-series-analysis/ Lecture 111. Convolution for Time Series and ARIMA
% A paper citation would be ideal, but none were found during an initial search
...
% TODO Confirm this used by Darts for the NN models behind the scenes, then mention and cite if so.
