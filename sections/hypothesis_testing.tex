...
and multivariate analysis of variance (MANOVA) for multiple dependent variables.
...
In this case additional \posthoc analysis is required, such as Tukey's HSD test.
