...
% TODO add text descriptions of results, including coefficents / HRs, and \pvalues where approach
...
% TODO add text descriptions of results, \pvalues where approach
