...
% TODo add example plots, talk about how to interpret, ie what models they suggest we try. May mostly be in the Box--Jenkins section
...
is a recipe for selecting what type of ARIMA-based model
to fit a given time series.

% TODO

% TODo add sections for ARCH, GARCH, VAR, ARMAX, Anomaly Detection? At least mention them...
