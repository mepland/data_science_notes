...
as in \cref{eq:stats:geo:P_trials} and \cref{fig:dist:geometric_trials},
or the probability of observing $k$ failed trials before the first success,
as in \cref{eq:stats:geo:P_failures} and \cref{fig:dist:geometric_failures}.
