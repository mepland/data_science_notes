...
\begin{align}
\partial_{\bm{\beta}} \, \bm{\beta}\transpose \mathbf{X}\transpose \mathbf{y} &= \mathbf{X}\transpose \mathbf{y}\,, \\
\partial_{\bm{\beta}} \, \bm{\beta}\transpose \mathbf{X}\transpose \mathbf{X} \bm{\beta} &= 2 \, \mathbf{X} \transpose \mathbf{X} \bm{\beta}\,.
\end{align}
\end{subequations}
...
% TODO what is the significance of any particular \beta_{i} coefficient, via t-test, chi2-test???
