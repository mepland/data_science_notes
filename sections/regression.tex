...
% TODO what is the significance of any particular \beta_{i} coefficient, via t-test, chi2-test??? Should be able to get distribution of any \beta_{i} analytically for OLS, but can use bootstrap sampling for more complex models.
