...
\newcommand{\indep}{\ensuremath{\perp\!\!\!\perp}\xspace} % https://tex.stackexchange.com/questions/79434/double-perpendicular-symbol-for-independence
...
% propensity score
\newcommand*{\ps}{\ensuremath{e}\xspace}
\newcommand*{\psx}{\ensuremath{\ps\left(x\right)}\xspace}
...
\newcommand*{\Naive}{\text{N{a\"i}ve}\xspace}
\newcommand*{\naive}{\text{n{a\"i}ve}\xspace}
...
% Software packages
\newcommand*{\figs}{\textsc{FIGS}\xspace}
